...
public class FormLoaderTask extends AsyncTask<String, String, FormLoaderTask.FECWrapper> {
    ...
    protected FECWrapper doInBackground(String... path) {
        ...
        if (formPath == null) {
            ...
            errorMsg = "formPath is null, please email wahyu_bs@outlook.com with a description of what you were doing when this happened.";
            return null;
        }
        ...
        try {
            ...
            Timber.w(e);
            errorMsg = "An unknown error has occurred. Please ask your project leadership to email wahyu_bs@outlook.com with information about this form.";
            errorMsg += "\n\n" + e.getMessage();
        }
            ...
            if (instanceXml.exists()) {
                ...
                try {
                    ...
                    if (usedSavepoint && !(e.getCause() instanceof XPathTypeMismatchException)) {
                        ...
                        throw new RuntimeException("An unknown error has occurred. Please ask your project leadership to email wahyu_bs@outlook.com with information about this form."
                                + "\n\n" + e.getMessage());
                    }
                }
            } else {
