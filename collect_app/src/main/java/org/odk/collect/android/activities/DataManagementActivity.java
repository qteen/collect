...
public class DataManagementActivity extends CollectAbstractActivity {
    ...
    private void setUpViewPager() {
        String[] tabNames = {getString(R.string.download_files)};
        ViewPager2 viewPager = findViewById(R.id.viewPager);
        TabLayout tabLayout = findViewById(R.id.tabLayout);
        viewPager.setAdapter(new DataManagementTabsAdapter(this));
